...
public class InGameSummonerQuerier {
    ...
    public String queryGameKey(String summonerName) throws IOException {
        ...
        String summonerId = getSummonerIdFromHttpClientBySummonerName(summonerName, client);
        InGameInfo gameInfo = getGameInfoFromHttpClientBySummonerId(client, summonerId);
        updateGameInfoOfGivenSummonerName(gameInfo);

        return gameInfo.getObservers().getEncryptionKey();
    }

	protected void updateGameInfoOfGivenSummonerName(InGameInfo gameInfo) {
	...
	protected InGameInfo getGameInfoFromHttpClientBySummonerId(HttpClient client, String summonerId)
	...
	protected String getSummonerIdFromHttpClientBySummonerName(String summonerName, HttpClient client)
